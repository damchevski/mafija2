...
ChatEngine <a href="User.html">User</a>s.</p>
...
machine.</p>
<p>You can get notified of when a chat is connected by subscribing to the <a href="Chat.html#event:$%2522.%2522connected">Chat#event:$"."connected</a> event.</p>
<pre class="prettyprint source lang-js"><code>chat.on('$.connected', () => {
    console.log('The chat is connected!');
});</code></pre><h2>Chat Events</h2><p>When two clients both join a <a href="Chat.html">Chat</a> with the same channel name
(<code>tutorial-chat</code> in this case), they can communicate with one
another.</p>
...
<li><a href="tutorial-search_.html">Search</a></li>
<li><a href="tutorial-privacy.html">Privacy</a></li>
<li><a href="tutorial-using.html">Plugins</a></li>
</ul>
<p>For example, <code>chat.users</code> contains a list of all the other <a href="User.html">User</a>s online in the chat. That list of users will update automatically.</p>
</article>
