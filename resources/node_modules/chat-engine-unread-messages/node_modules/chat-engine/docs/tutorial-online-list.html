...
<p>A list of all the clients who have joined the chatroom is available from <a href="Chat.html#users">Chat#users</a>.</p>
<pre class="prettyprint source lang-js"><code>console.log(chat.users);</code></pre><p>It returns a list of <a href="User.html">User</a>s who have also joined this <a href="Chat.html">Chat</a>.</p>
<pre class="prettyprint source lang-js"><code>{
  ian: {},
  nick: {}
}</code></pre><p>This property is kept in sync as <a href="User.html">User</a>s join and leave the <a href="Chat.html">Chat</a>s. If you're using
...
<ul>
<li>When first joining a <a href="Chat.html">Chat</a>, the <a href="Chat.html">Chat</a> will emit <a href="Chat.html#event:$%2522.%2522online%2522.%2522here">$.online.here</a> for every <a href="User.html">User</a> in the room.</li>
<li>Any time a new <a href="User.html">User</a> joins, the <a href="Chat.html">Chat</a> emits <a href="Chat.html#event:$%2522.%2522online%2522.%2522join">$.online.join</a>.</li>
</ul>
...
};</code></pre><p>Then, listen for the <code>$.ready</code> event to find out when the client is connected to the <a href="Chat.html">Chat</a>.</p>
<pre class="prettyprint source lang-js"><code>ChatEngine.on('$.ready', (payload) => {
  appendMessage('Status', 'Connected to chat!');
});</code></pre><p>We subscribe to the <code>$.online.*</code> event to learn about online <a href="User.html">User</a>s.</p>
<pre class="prettyprint source lang-js"><code>ChatEngine.on('$.online.*', (payload) => {
