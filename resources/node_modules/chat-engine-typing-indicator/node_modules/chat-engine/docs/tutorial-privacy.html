...
<article>
    <h3>Public Chat</h3><p>This is an example of a public chat any <a href="User.html">User</a> can join.</p>
<pre class="prettyprint source lang-js"><code>new Chat('channel', false);</code></pre><h3>Private Chat</h3><p>This is a private chat that a user must authenticated in. Usually this is done via <a href="Chat.html#invite">Chat#invite</a>. See <a href="tutorial-private.html">Private Chats</a></p>
<pre class="prettyprint source lang-js"><code>new Chat('channel', true);</code></pre><h2>Direct Chat</h2><p><a href="User.html#direct">User#direct</a> is a <a href="Chat.html">Chat</a> that any <a href="User.html">User</a> can <a href="Chat.html#emit">Chat#emit</a> on, but only the user receives events on.</p>
...
<h2>Encryption</h2><p>It's possible to encrypt messages traveling over the network by supplying the property <code>cipherKey</code> into the first parameter of <a href="ChatEngine.html#connect">ChatEngine#connect</a>. See <a href="https://www.pubnub.com/docs/web-javascript/pam-security#message_layer_encryption_with_aes256">Message Layer Encryption with AES256</a>.</p>
</article>
