...
<article>
    <h2>Users</h2><p><a href="User.html">User</a>s are other browser windows connected to the <a href="Chat.html">Chat</a> via <a href="ChatEngine.html">ChatEngine</a>. A <a href="User.html">User</a> represents a connected client.</p>
<h2>Me</h2><p>When a client calls <a href="ChatEngine.html#connect">ChatEngine#connect</a>, they create a special <a href="User.html">User</a> called <a href="Me.html">Me</a>. <a href="Me.html">Me</a> represents &quot;this <a href="User.html">User</a> for this instance.&quot;</p>
<p><a href="Me.html">Me</a> and <a href="User.html">User</a> are similar in many ways, with the main difference being that <a href="Me.html">Me</a> has the ability to edit <a href="Me.html#state">Me#state</a> via <a href="Me.html#update">Me#update</a> while you can not updated some other <a href="User.html#state">User#state</a>.</p>
<p>See <a href="tutorial-me_.html">Me</a> for more information.</p>
<h2>State</h2><p>So how do we add other information to Users? Like a profile? We update <a href="Me.html#state">Me#state</a> via <a href="Me.html#update">Me#update</a>.</p>
...
<p>Let's give <a href="Me.html">Me</a> a unique username color. Here's a function to choose a random color.</p>
...
};</code></pre><p>We can update <a href="Me.html">Me</a>'s state on the network with the <a href="Me.html#update">Me#update</a> method.</p>
<pre class="prettyprint source lang-js"><code>me.update({color: getColor()});</code></pre><p>Then we can listen for the state event in other windows via <a href="ChatEngine.html#event:$%2522.%2522state">$.state</a>:</p>
<pre class="prettyprint source"><code>ChatEngine.global.on('$.state', (payload) => {
  console.log(payload.user + ' updated state: ' + payload.state);
});</code></pre><p>You can set Me#staet during connection by supplying the second param of <a href="ChatEngine.html#connect">ChatEngine#connect</a>.</p>
<pre class="prettyprint source lang-js"><code>ChatEngine.connect('ian-jennings', {color: getColor()});</code></pre><p>What if we want to get a <a href="User.html">User</a>'s state some other time without events? You can simply check for the User.state property.</p>
...
console.log(user.state);</code></pre>
</article>
