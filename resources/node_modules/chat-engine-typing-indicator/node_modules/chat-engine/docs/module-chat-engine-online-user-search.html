...
<article>
    ...
    <span class="type-signature"></span>require('chat-engine-online-user-search')<span class="signature">(config<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>//providing a config is optional, the defaults are below
let config = { prop: 'uuid', caseSensitive: false }
chat.plugin(ChatEngineCore.plugin['chat-engine-online-user-search'](config));

let results = chat.onlineUserSearch.search('foo');</code></pre>
