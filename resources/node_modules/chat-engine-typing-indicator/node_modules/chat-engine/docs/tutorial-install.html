...
<pre class="prettyprint source lang-js"><code>&lt;script src=&quot;//pubnub.github.io/chat-engine/dist/0.6.1/chat-engine.js&quot;>&lt;/script></code></pre><p>The ChatEngine library will then be available as <code>window.ChatEngineCore</code>.</p>
