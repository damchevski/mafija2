...
<article>
    <p><a href="ChatEngine.html#.global">ChatEngine.global</a> is a global <a href="Chat.html">Chat</a> room that all instances of <a href="ChatEngine.html">ChatEngine</a> connect to by default. It is a convenience property that provides some handy utility.</p>
...
<ul>
<li>All <a href="User.html">User</a>s connect to ChatEngine.global by default (during <a href="ChatEngine.html#connect">ChatEngine#connect</a>)</li>
<li><a href="Me.html#update">Me#update</a> and <a href="User.html#state">User#state</a> operates using ChatEngine#global. See: <a href="tutorial-users.html">Users and State</a></li>
</ul>
</article>
