...
<pre class="prettyprint source"><code>let privChat = new Chat('private', true);</code></pre><p>The second parameter tells ChatEngine to lock down the chat and only make it
accessible to those who are invited.</p>
<h2>Inviting to Private Chats</h2><p>In order to securely invite other users to the chat, the client can call
the <a href="Chat.html#invite">Chat#invite</a> method.</p>
...
<h2>Receiving invites to Private Chats</h2><p>You can get notified of invites by subscribing to the <a href="Me.html#event:$%2522.%2522invite">$.invite</a> event.</p>
