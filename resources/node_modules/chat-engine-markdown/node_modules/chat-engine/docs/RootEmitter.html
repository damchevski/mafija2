...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine_src_modules_root_emitter.js.html">chat-engine/src/modules/root_emitter.js</a>, <a href="chat-engine_src_modules_root_emitter.js.html#line6">line 6</a>
    </li></ul></dd>
...
<div class="description">
    <p>The <a href="ChatEngine.html">ChatEngine</a> object is a RootEmitter. Configures an event emitter that other ChatEngine objects inherit. Adds shortcut methods for
<code>this.on()</code>, <code>this.emit()</code>, etc.</p>
</div>
