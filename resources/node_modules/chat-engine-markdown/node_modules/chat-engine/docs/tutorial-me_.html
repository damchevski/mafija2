...
<h3>ChatEngine.connect()</h3><p>The function connects to <a href="ChatEngine.html#.global">ChatEngine.global</a>. The paramter <code>ian</code> is a unique identifier for the new <a href="User.html">User</a>.</p>
<p>When ChatEngine has been connected, a fancy <a href="Me.html">Me</a> object is returned by the <a href="ChatEngine.html#event:$%2522.%2522ready">$.ready</a> event.</p>
<pre class="prettyprint source lang-js"><code>ChatEngine.on('$.ready', (data) => {
    let me = data.me;
});</code></pre><p>At this point the <a href="Me.html">Me</a> object is fully usable:</p>
<pre class="prettyprint source lang-js"><code>me.update({lastOnline: new Date()});</code></pre><p>See <a href="tutorial-users.html">Users and State</a> for more information on <a href="Me.html#update">Me#update</a>.</p>
...
<p>Remember when we defined <a href="Me.html">Me</a> and supplied <code>ian</code> as the first parameter of <a href="ChatEngine.html#connect">ChatEngine#connect</a>? Well, we can supply whatever we want to use as the <a href="User.html">User</a> identifier there. Let's use our new function!</p>
