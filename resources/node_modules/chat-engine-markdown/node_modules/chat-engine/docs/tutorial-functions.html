...
<pre class="prettyprint source"><code>chat-engine#chat#private.*</code></pre><h2>Code</h2><p>You can access the ChatEngine Event type via <code>request.messag=e.event</code> and the
