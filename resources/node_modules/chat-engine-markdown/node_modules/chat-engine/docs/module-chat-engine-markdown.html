...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Renders markdown from the <code>message</code> event.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-markdown_src_plugin.js.html">chat-engine-markdown/src/plugin.js</a>, <a href="chat-engine-markdown_src_plugin.js.html#line29">line 29</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>chat.plugin(ChatEngineCore.plugin['chat-engine-markdown']());
...
// 'This is some &lt;em>markdown&lt;/em> &lt;strong>for sure&lt;/strong>.</code></pre>
