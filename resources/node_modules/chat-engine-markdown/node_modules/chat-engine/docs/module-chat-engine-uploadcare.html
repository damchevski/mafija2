...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Emits the <code>$uploadCare.upload</code> event when UploadCare completes an uplaod</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-uploadcare_src_plugin.js.html">chat-engine-uploadcare/src/plugin.js</a>, <a href="chat-engine-uploadcare_src_plugin.js.html#line40">line 40</a>
    </li></ul></dd>
...
&lt;script src=&quot;dist/chat-engine-uploadcare.js&quot; type=&quot;text/javascript&quot;>&lt;/script></code></pre><pre class="prettyprint source lang-js"><code>// initialize the UploadCare Widget
...
Listen to upload events from the <a href="Chat.html">Chat</a>.
chat.on('$uploadcare.upload', (payload) => {
    ...
    <pre class="prettyprint"><code>Include the [Uploadcare](https://uploadcare.com) Javascript files and configure the widget. Check out the [Uploadcare Widget Docs](https://uploadcare.com/documentation/javascript_api/v2/) for more information.</code></pre>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-uploadcare_src_plugin.js.html">chat-engine-uploadcare/src/plugin.js</a>, <a href="chat-engine-uploadcare_src_plugin.js.html#line44">line 44</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chat-engine-uploadcare_src_plugin.js.html">chat-engine-uploadcare/src/plugin.js</a>, <a href="chat-engine-uploadcare_src_plugin.js.html#line57">line 57</a>
    </li></ul></dd>
