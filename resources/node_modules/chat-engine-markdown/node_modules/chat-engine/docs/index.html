...
<div id="main">
    ...
    <section class="readme">
        <article><h1>New in v0.6.x</h1><ul>
<li><a href="Chat.html#search">New Search (History) Class</a><ul>
<li><code>chat.search({event: 'message'}).on('messsage', () =&gt; {})</code>.</li>
<li>Search returns event emitter for superior code quality</li>
<li>Search now pages to iterate over complete history</li>
<li>Ability to search between dates</li>
<li>Events for <a href="Search.html#event:$%2522.%2522search%2522.%2522start">$.search.start</a> and <a href="Search.html#event:$%2522.%2522page%2522.%2522request">$.page.request</a></li>
</ul>
</li>
<li>Functions auto setup in setup.js</li>
<li>Unit testing coverage</li>
<li>Ability to subscribe to events indicating a class was created locally<ul>
<li><a href="ChatEngine.html#event:$%2522.%2522created%2522.%2522chat">ChatEngine#$.created.chat</a></li>
<li><a href="ChatEngine.html#event:$%2522.%2522created%2522.%2522user">ChatEngine#$.created.user</a></li>
<li><a href="ChatEngine.html#event:$%2522.%2522created%2522.%2522me">ChatEngine#$.created.me</a></li>
</ul>
</li>
<li>Source of <code>ChatEngine</code> events available as second param in callback.<ul>
<li><code>ChatEngine.on('$.created.chat', (payload, chat) =&gt; {})</code>;</li>
</ul>
</li>
<li>Full es6 class syntax</li>
<li>protoPlugin() -&gt; <a href="ChatEngine.html#proto">ChatEngine#proto</a></li>
<li>Docs updated<ul>
<li>Docs rendering repaired</li>
<li>Docs migrated from 0.4.x -&gt; 0.6.x</li>
<li>Improved hyperlinks between events and methods</li>
<li>Docs build process in gulp (<code>compile_docs</code>, <code>watch_docs</code>, <code>serve_docs</code>, and <code>docs_dev</code> to do all three).</li>
</ul>
</li>
</ul>
<h1>Development</h1><h2>Cloning</h2><p>Clone repos (chat-engine and plugins).</p>
