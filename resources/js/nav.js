$(document).ready(function(){
  ...
  $('body').css({
        "background-image": " url('http://mktechportal.con.mk/resources/img/darkBackground.jpg')"
      });
  $('.row').css('margin','0');
  $('#box').css('padding-bottom','50px');
  $('.form-check-label').css('margin-left','10px').css('margin-bottom','15px');
  $('.addPeople').css('margin-left','9%');
  $('.search').css('margin-right','20%');
  }
